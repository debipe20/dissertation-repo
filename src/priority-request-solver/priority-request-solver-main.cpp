...
int main()
{
    ...
    while (true)
    {
        ...
        */
        ...
        else if ((msgType == static_cast<int>(msgType::priorityRequest)) || (msgType == static_cast<int>(msgType::arrivalTableData)))
        {
            if (priorityRequestSolver.checkTrafficSignalTimingPlanStatus())
            {
                if (priorityRequestSolver.getOptimizationMethod() == "MILP")
                {
                    ...
                    */
                    ...
                    priorityRequestSolver.setArrivalTable(receivedJsonString);
                ...
                */
                ...
                if (priorityRequestSolver.checkUpdatesForPriorityWeights())
                    priorityRequestSolver.getPriorityWeightsAndMethod();
            }
